...
export async function seed(knex) {
  ...
  await knex("pending_items").insert([
    ...
    },
    {
      ...
      type: "observation",
      description: "Enviar a base consolidada de inadimplência por fornecedor.",
      comment: "Enviar a base consolidada de inadimplência por fornecedor.",
      status: "requested",
      request_attachment: true,
    ...
    },
    {
      ...
      description: "Informar a volumetria aproximada da base.",
      comment: "Informar a volumetria aproximada da base.",
      status: "requested",
      request_attachment: false,
      created_by: "joao.analyst@empresa.com",
      created_at: "2026-09-21 09:50:00",
    },
    // Request 29: 1 linha por pendência lógica, em estado final `validated`
    // (ciclo requested → responded → validated registrado via
    // responded_at/validated_at na mesma row, conforme o contrato de
    // pendências — sem linhas irmãs por estágio).
    {
      ...
      description: "Informar a volumetria atual do fechamento.",
      comment: "Informar a volumetria atual do fechamento.",
      status: "validated",
    ...
    },
    {
      ...
      type: "observation",
      description: "Anexar o comprovante de volume mensal.",
      comment: "Anexar o comprovante de volume mensal.",
      status: "validated",
